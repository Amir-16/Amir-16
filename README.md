...
- 🌱 I'm currently working with **Python**,**PHP**, **Node.js**, **Golang**, **React.js**, **Docker**, **Kubernetes (K8s)** and **AWS**.  
- 🚀 I'm also focused on building my expertise to become **Solution Architect**.
